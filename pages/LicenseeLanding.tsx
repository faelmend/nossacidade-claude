            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col">
                    ...
                    <p className="text-slate-600 flex-grow">
                        ...
                        <br/><br/>
                        <em className="text-sm text-slate-500">Exemplo: Você compra 1 licença e administra Cidade A (25k) + Cidade B (15k) + Cidade C (10k).</em>
                    </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col">
                    ...
                    <p className="text-slate-600 flex-grow">
                        ...
                        <br/><br/>
                        <em className="text-sm text-slate-500">Exemplo: Cidade A (150k habitantes) equivale a 3 blocos de licença. Você pode começar com 1 e expandir depois.</em>
                    </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col">
                    ...
                    <p className="text-slate-600 flex-grow">
                        ...
                        <br/><br/>
                        <em className="text-sm text-slate-500">Ideal para quem quer garantir exclusividade total em aglomerados urbanos ou múltiplas cidades.</em>
                    </p>
                </div>
            </div>
        </div>

...
import { Facebook, Instagram, MessageCircle, Briefcase, Youtube, Mail, Megaphone, FileCode } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-blue-900 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-blue-400 text-center md:text-left">
          ...
          <div className="flex items-center gap-4 mt-2 md:mt-0">
             <Link to="/wp-converter" className="flex items-center gap-1 text-xs text-blue-600 hover:text-blue-300 transition-colors" title="Ferramenta de Migração">
                <FileCode className="w-3 h-3" /> WP-Migrate
             </Link>
             <p className="flex items-center justify-center">Feito com <span className="text-red-500 mx-1">❤</span> em Minas Gerais.</p>
          </div>
        </div>
      </div>
    </footer>
